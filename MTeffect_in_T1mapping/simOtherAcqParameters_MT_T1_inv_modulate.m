...
savePrefix ='SeqCompare'; % 'Sled2001', 'LorentzT270',
...
savePrefixOld ='ModulateTP'; % 'Sled2001', 'LorentzT270',

load( fullfile( outputPath, [savePrefixOld,'_vfa_T1.mat']));
load( fullfile(outputPath,[savePrefixOld,'_mp2rage_T1_rev1.mat']));
