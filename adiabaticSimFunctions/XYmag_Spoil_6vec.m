function M_out = XYmag_Spoil_6vec(Params, M_in, t, MTC, Gradient)
...
if Params.PerfectSpoiling
    M_out = SpinEvolution_Relaxation_6vec( Params, M_in, t); % Calculate relaxation over period t
    %M_out(1:4,:) = 0; % Spoil. Easier to do if you are keeping isochromats
else
    error('Gradient spoiling not implemented yet');
